...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF66BEFF);
  late Color secondary = const Color(0xFFFEB05D);
  late Color tertiary = const Color(0xFFF5F2F2);
  late Color alternate = const Color(0xFF2B2A2A);
